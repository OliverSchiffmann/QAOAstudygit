...
file_name = 'QUBO_batches/batch_QUBO_data_MaxCut_7q_.json'
...
def load_qubo_and_build_hamiltonian(file_path,instance_id):
    ...
    for qubo_instance in all_qubos_data:
        if qubo_instance["instance_id"] == instance_id: # Assumes 'instance_id' exists and is correct
...
cost_hamiltonian, constant_offset, num_qubits, problem_type = load_qubo_and_build_hamiltonian(file_name, instanceIndex)
